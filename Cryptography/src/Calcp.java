...
public class Calcp {
	...
	public static void myMethod(List<Order> order) throws IOException {
		...
		g: for (Order o : order) {
			...
			x = new BigInteger(String.valueOf(o.getX()));
			y = new BigInteger(String.valueOf(o.getY()));
